%global python39_sitearch %(python3.9 -c "import sysconfig; print(sysconfig.get_path('platlib'))")
...
# drpm, zchunk and libmodulemd disabled (not available in UBI-8)
...
%{python39_sitearch}/createrepo_c/
%{python39_sitearch}/createrepo_c-*.egg-info
