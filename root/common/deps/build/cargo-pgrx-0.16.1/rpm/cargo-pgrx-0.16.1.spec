...
Name:     cargo-pgrx-0.16.1
Version:  0.16.1
Release:  1%{?dist}
Summary:  cargo-pgrx 0.16.1 build tool for pgrx-based PostgreSQL extensions
License:  MIT
...
# Extensions select the matching tool with `BuildRequires: cargo-pgrx = 0.16.1`.
...
%changelog
* Tue Jun 30 2026 Percona Development Team <info@percona.com> - 0.16.1-1
- Package cargo-pgrx 0.16.1 for building pgrx 0.16.1 based PostgreSQL extensions
