...
%global srcname python3-botocore

Summary:        Low-level, data-driven core of boto3
Name:           %{python3_pkgprefix}-botocore
Version:        1.0.0
Release:        1%{?dist}
...
Requires:       %{python3_pkgprefix}-dateutil >= 2.1
...
%defattr(-,root,root)
%dir %{python3_sitelib}/botocore
%dir %{python3_sitelib}/botocore/__pycache__
%dir %{python3_sitelib}/botocore/data

%changelog
* Mon Mar 30 2026 Percona Build/Release Team <eng-build@percona.com> - 1.38.19-1
- Initial build of python3-botocore 1.38.19
