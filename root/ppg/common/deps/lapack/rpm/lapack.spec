...
# Bugzilla 1814756
Patch8: 87536aa3c8bb0af00f66088fb6ac05d87509e011.patch
...
cherk.f.3 cherk.3 chpmv.f.3 chpmv.3 chpr.f.3 chpr.3 chpr2.f.3 chpr2.3 crotg.3 \
...
dnrm2.3 drot.f.3 drot.3 drotg.3 drotm.f.3 drotm.3 drotmg.f.3 drotmg.3 dsbmv.f.3 \
...
dtrsv.3 dzasum.f.3 dzasum.3 dznrm2.3 icamax.f.3 icamax.3 idamax.f.3 idamax.3 \
isamax.f.3 isamax.3 izamax.f.3 izamax.3 lsame.3 sasum.f.3 sasum.3 saxpy.f.3 saxpy.3 \
scabs1.f.3 scabs1.3 scasum.f.3 scasum.3 scnrm2.3 scopy.f.3 scopy.3 sdot.f.3 sdot.3 \
sdsdot.f.3 sdsdot.3 sgbmv.f.3 sgbmv.3 sgemm.f.3 sgemm.3 sgemv.f.3 sgemv.3 sger.f.3 sger.3 \
snrm2.3 srot.f.3 srot.3 srotg.3 srotm.f.3 srotm.3 srotmg.f.3 srotmg.3 \
...
zherk.f.3 zherk.3 zhpmv.f.3 zhpmv.3 zhpr.f.3 zhpr.3 zhpr2.f.3 zhpr2.3 zrotg.3 \
...
%changelog
* Thu May 21 2026 Percona Development <info@percona.com> - 3.9.0-1
- Initial packaging of lapack for Percona OBS
