...
%global srcname python3-wcwidth

Summary:        Measures the displayed width of unicode strings in a terminal
Name:           %{python3_pkgprefix}-wcwidth
Version:        1.0.0
Release:        1%{?dist}
...
%description
wcwidth measures the number of terminal column positions a wide character or string
...
%defattr(-,root,root)
%dir %{python3_sitelib}/wcwidth
%dir %{python3_sitelib}/wcwidth/__pycache__

%changelog
* Mon Mar 30 2026 Percona Build/Release Team <eng-build@percona.com> - 0.2.13-1
- Initial build of python3-wcwidth 0.2.13
